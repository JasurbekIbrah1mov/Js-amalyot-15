class RandomUser {
  ...
  //Ma'lumotlarni olib ekranga chiqaradigon joyi
...
// BTN bosganda ishga tushunredigon joyi
document.getElementById("generate-btn").addEventListener("click", () => {
  RandomUser.FetchFromAPI();
});
//HTML dan user ma'lumotlarni o'chirib, js orqali uzatishga yordam beradi
RandomUser.FetchFromAPI();
